...
static constexpr std::array<sunindextype, 49> dwdx_colptrs_cell_cycle_v3_0_0_rescaled_ = {
...
void dwdx_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &dwdx){
    dwdx.set_indexptrs(gsl::make_span(dwdx_colptrs_cell_cycle_v3_0_0_rescaled_));
}
} // namespace amici
} // namespace model_cell_cycle_v3_0_0_rescaled