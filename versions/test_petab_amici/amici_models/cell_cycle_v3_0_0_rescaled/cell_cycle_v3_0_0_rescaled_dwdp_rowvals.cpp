...
static constexpr std::array<sunindextype, 154> dwdp_rowvals_cell_cycle_v3_0_0_rescaled_ = {
...
void dwdp_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &dwdp){
    dwdp.set_indexvals(gsl::make_span(dwdp_rowvals_cell_cycle_v3_0_0_rescaled_));
}
} // namespace amici
} // namespace model_cell_cycle_v3_0_0_rescaled