...
/*-----------------------------------------------
              @(target):= _cell_cycle_v3_0_0_rescaled.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cell_cycle_v3_0_0_rescaled

#else
#  define SWIG_init    init_cell_cycle_v3_0_0_rescaled

#endif
#define SWIG_name    "_cell_cycle_v3_0_0_rescaled"
