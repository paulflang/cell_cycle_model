...
extern void Jy_cell_cycle_v3_0_0_rescaled(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_cell_cycle_v3_0_0_rescaled(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_cell_cycle_v3_0_0_rescaled(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals, int index);
extern void dwdp_cell_cycle_v3_0_0_rescaled(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp);
extern void dwdp_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals);
extern void dwdx_cell_cycle_v3_0_0_rescaled(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals);
extern void dwdw_cell_cycle_v3_0_0_rescaled(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdw_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs);
extern void dwdw_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals);
extern void dxdotdw_cell_cycle_v3_0_0_rescaled(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals);
extern void dxdotdp_explicit_cell_cycle_v3_0_0_rescaled(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_explicit_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals);
extern void dxdotdx_explicit_cell_cycle_v3_0_0_rescaled(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdx_explicit_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &colptrs);
extern void dxdotdx_explicit_rowvals_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &rowvals);

extern void dydx_cell_cycle_v3_0_0_rescaled(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_cell_cycle_v3_0_0_rescaled(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_cell_cycle_v3_0_0_rescaled(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_cell_cycle_v3_0_0_rescaled(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_cell_cycle_v3_0_0_rescaled(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_cell_cycle_v3_0_0_rescaled(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_cell_cycle_v3_0_0_rescaled(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_cell_cycle_v3_0_0_rescaled(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_cell_cycle_v3_0_0_rescaled(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_cell_cycle_v3_0_0_rescaled(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_cell_cycle_v3_0_0_rescaled(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);
extern void x_rdata_cell_cycle_v3_0_0_rescaled(realtype *x_rdata, const realtype *x, const realtype *tcl);
extern void x_solver_cell_cycle_v3_0_0_rescaled(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_cell_cycle_v3_0_0_rescaled(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_cell_cycle_v3_0_0_rescaled : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_cell_cycle_v3_0_0_rescaled()
        : amici::Model_ODE(
              49,                                // nx_rdata
              49,                            // nxtrue_rdata
              48,                               // nx_solver
              ...
              std::vector<realtype>{0.0055440055, 0.0069300068999999997, 0.0013860013999999999, 0.020790020999999999, 1.3860013999999999e-5, 4.1580041999999997, 0.00013860013999999999, 0.00034650034999999998, 0.34650035000000001, 6.9300068999999998e-6, 0.69300068999999997, 6.9300068999999999e-5, 0.0013860013999999999, 0.0013860013999999999, 0.069300069000000006, 3.4650034999999998e-5, 3.4650034999999999, 0.00034650034999999998, 0.00034650034999999998, 0.0034650035000000001, 3.4650034999999998e-5, 0.00017325017000000001, 3.4650034999999998e-6, 6.9300068999999998e-6, 0.51975051999999999, 6.9300068999999998e-6, 0.0027720027999999998, 0.00069300068999999999, 0.0034650035000000001, 0.017325017000000002, 0.00069300068999999999, 0.17325017000000001, 0.00034650034999999998, 0.34650035000000001, 0.00034650034999999998, 0.34650035000000001, 0.0069300068999999997, 6.9300068999999999e-5, 0.00069300068999999999, 0.00069300068999999999, 0.0034650035000000001, 3.4650034999999998e-5, 6.9300068999999998e-6, 0.51975051999999999, 6.9300068999999998e-6, 0.00086625087000000004, 0.00086625087000000004, 0.00069300068999999999, 0.00034650034999999998, 0.0069300068999999997, 0.0017325017, 0.069300069000000006, 6.9300068999999999e-5, 0.0069300068999999997, 0.00069300068999999999, 0.0069300068999999997, 0.069300069000000006, 0.00069300068999999999, 0.0069300068999999997, 0.069300069000000006, 4.7124047e-5, 0.39501039999999998, 6.9300068999999998e-6, 0.69300068999999997, 2.7720027999999999e-5, 0.00027720027999999998, 0.00086625087000000004, 0.0069300068999999997, 6.9300068999999999e-5, 6.9300068999999999e-5, 0.034650035000000003, 6.9300068999999998e-6, 0.51975051999999999, 6.9300068999999998e-6, 0.0034650035000000001, 0.34650035000000001, 0.034650035000000003, 0.34650035000000001, 0.069300069000000006, 0.34650035000000001, 0.17325017000000001, 0.0069300068999999997, 0.00055440055, 0.013860014, 0.13860014000000001},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_cell_cycle_v3_0_0_rescaled(*this);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_cell_cycle_v3_0_0_rescaled(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_cell_cycle_v3_0_0_rescaled(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_cell_cycle_v3_0_0_rescaled(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_cell_cycle_v3_0_0_rescaled( dJydy,  iy,  p,  k,  y,  sigmay,  my);
    }

    virtual void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {
        dJydy_colptrs_cell_cycle_v3_0_0_rescaled(colptrs, index);
    }

    virtual void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {
        dJydy_rowvals_cell_cycle_v3_0_0_rescaled(rowvals, index);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp) override {
        dwdp_cell_cycle_v3_0_0_rescaled( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp);
    }

    virtual void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdp_colptrs_cell_cycle_v3_0_0_rescaled(colptrs);
    }

    virtual void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdp_rowvals_cell_cycle_v3_0_0_rescaled(rowvals);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_cell_cycle_v3_0_0_rescaled( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }

    virtual void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdx_colptrs_cell_cycle_v3_0_0_rescaled(colptrs);
    }

    virtual void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdx_rowvals_cell_cycle_v3_0_0_rescaled(rowvals);
    }
    ...
    virtual void fdwdw(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdw_cell_cycle_v3_0_0_rescaled( dwdw,  t,  x,  p,  k,  h,  w,  tcl);
    }

    virtual void fdwdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdw_colptrs_cell_cycle_v3_0_0_rescaled(colptrs);
    }

    virtual void fdwdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdw_rowvals_cell_cycle_v3_0_0_rescaled(rowvals);
    }
    ...
    virtual void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_cell_cycle_v3_0_0_rescaled( dxdotdw,  t,  x,  p,  k,  h,  w);
    }

    virtual void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdw_colptrs_cell_cycle_v3_0_0_rescaled(colptrs);
    }

    virtual void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdw_rowvals_cell_cycle_v3_0_0_rescaled(rowvals);
    }
    ...
    virtual void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdp_explicit_cell_cycle_v3_0_0_rescaled( dxdotdp_explicit,  t,  x,  p,  k,  h,  w);
    }

    virtual void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdp_explicit_colptrs_cell_cycle_v3_0_0_rescaled(colptrs);
    }

    virtual void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdp_explicit_rowvals_cell_cycle_v3_0_0_rescaled(rowvals);
    }
    ...
    virtual void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdx_explicit_cell_cycle_v3_0_0_rescaled( dxdotdx_explicit,  t,  x,  p,  k,  h,  w);
    }

    virtual void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdx_explicit_colptrs_cell_cycle_v3_0_0_rescaled(colptrs);
    }

    virtual void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdx_explicit_rowvals_cell_cycle_v3_0_0_rescaled(rowvals);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
        ...
        dydx_cell_cycle_v3_0_0_rescaled(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_cell_cycle_v3_0_0_rescaled(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsigmay(realtype *sigmay, const realtype t, const realtype *p,
        ...
        sigmay_cell_cycle_v3_0_0_rescaled(sigmay, t, p, k);
    }
    ...
    virtual void fsx0(realtype *sx0, const realtype t, const realtype *x0,
                      const realtype *p, const realtype *k,
                      const int ip) override {
        sx0_cell_cycle_v3_0_0_rescaled(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_cell_cycle_v3_0_0_rescaled(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_cell_cycle_v3_0_0_rescaled( w,  t,  x,  p,  k,  h,  tcl);
    }
    ...
    virtual void fx0(realtype *x0, const realtype t, const realtype *p,
                     const realtype *k) override {
        x0_cell_cycle_v3_0_0_rescaled(x0, t, p, k);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_cell_cycle_v3_0_0_rescaled(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_cell_cycle_v3_0_0_rescaled(xdot, t, x, p, k, h, w);
    }
    ...
    virtual void fy(realtype *y, const realtype t, const realtype *x,
                    const realtype *p, const realtype *k, const realtype *h,
                    const realtype *w) override {
        y_cell_cycle_v3_0_0_rescaled(y, t, x, p, k, h, w);
    }
    ...
    virtual void fx_rdata(realtype *x_rdata, const realtype *x, const realtype *tcl) override {
        x_rdata_cell_cycle_v3_0_0_rescaled( x_rdata,  x,  tcl);
    }


    virtual void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_cell_cycle_v3_0_0_rescaled( x_solver,  x_rdata);
    }


    virtual void ftotal_cl(realtype *total_cl, const realtype *x_rdata) override {
        total_cl_cell_cycle_v3_0_0_rescaled( total_cl,  x_rdata);
    }


    std::string getName() const override {
        return "cell_cycle_v3_0_0_rescaled";
    }
