...
static constexpr std::array<sunindextype, 86> dwdp_colptrs_cell_cycle_v3_0_0_rescaled_ = {
...
void dwdp_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &dwdp){
    dwdp.set_indexptrs(gsl::make_span(dwdp_colptrs_cell_cycle_v3_0_0_rescaled_));
}
} // namespace amici
} // namespace model_cell_cycle_v3_0_0_rescaled