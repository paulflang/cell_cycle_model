...
static constexpr std::array<sunindextype, 156> dxdotdw_colptrs_cell_cycle_v3_0_0_rescaled_ = {
...
void dxdotdw_colptrs_cell_cycle_v3_0_0_rescaled(SUNMatrixWrapper &dxdotdw){
    dxdotdw.set_indexptrs(gsl::make_span(dxdotdw_colptrs_cell_cycle_v3_0_0_rescaled_));
}
} // namespace amici
} // namespace model_cell_cycle_v3_0_0_rescaled