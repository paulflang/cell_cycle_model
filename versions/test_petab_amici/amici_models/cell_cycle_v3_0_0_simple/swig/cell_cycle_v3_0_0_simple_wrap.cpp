...
/*-----------------------------------------------
              @(target):= _cell_cycle_v3_0_0_simple.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cell_cycle_v3_0_0_simple

#else
#  define SWIG_init    init_cell_cycle_v3_0_0_simple

#endif
#define SWIG_name    "_cell_cycle_v3_0_0_simple"
