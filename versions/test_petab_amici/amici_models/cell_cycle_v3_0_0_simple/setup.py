...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "cell_cycle_v3_0_0_simple.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'cell_cycle_v3_0_0_simple._cell_cycle_v3_0_0_simple',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'cell_cycle_v3_0_0_simple',
...
# Install
setup(
    name='cell_cycle_v3_0_0_simple',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model cell_cycle_v3_0_0_simple',
